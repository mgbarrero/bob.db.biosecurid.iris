...
project = u'BiosecurId Iris Database (Bob API)'
import time
...
from bob.db.biosecurid.iris.driver import Interface
...
man_pages = [
    ('index', 'bob', u'BiosecurId Iris Database (Bob API) Documentation', [u''], 1)
]
